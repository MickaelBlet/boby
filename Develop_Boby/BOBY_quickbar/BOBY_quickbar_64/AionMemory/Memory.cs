...
namespace MemoryLib
{
	public class Memory
	{
		...
		public static long ReadLong(IntPtr pHandle, long Address, bool reverse)
		{
		...
		public static long ReadLong(IntPtr pHandle, long Address)
		{ return ReadLong(pHandle, Address, false); }
