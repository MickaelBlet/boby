...
namespace BobyMultitools
{
    ...
    /// </summary>
    public partial class Win_Radar_Popup : Window
    {
        ...
        public void PopupContent(Aion_Game.Entity entity)
        {
        ...
        private int Get_Distance_Real(Aion_Game.Entity entity)
        {
