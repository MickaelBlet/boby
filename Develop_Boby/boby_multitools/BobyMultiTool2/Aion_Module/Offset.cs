...
namespace MemoryLib
{
    ...
    public class Offset
    {
        ...
        public static void Loading(int Base)
        {
            ...
            Cube.ListW = 0x58;
            Cube.ListH = 0X60;
            Cube.ItemListW = 0x330;
            Cube.ItemListH = 0x338;
            Cube.ItemID = 0x88;
            Cube.ItemCD = 0x98;
            Cube.ItemName1 = 0x48;
            Cube.ItemName2 = 0x4;
            ...
            Chain.AbilityId = 0x3F4;
            Chain.Timeout = Chain.AbilityId + 0x5C;
            Chain.IsElapsed = 0x418;

            Pet.Loot = 0xEBC4E0;

            AbilityList.Pointer = Cube.BaseCount;
            AbilityList.FirstItem = 0xA90;
            ...
            Ability.Cooldown = 0x48;
            Ability.CooldownEnd = 0x4C;
        ...
        public class Game
        {
            ...
            public static long TESTAbyPt = 0xE4B7C0;
