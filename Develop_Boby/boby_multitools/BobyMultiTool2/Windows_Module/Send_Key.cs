...
{
    public enum eWindowsVirtualKey
    {
    ...
    class Send_Key
    {
        ...
        public static void Post(IntPtr whandle, eWindowsVirtualKey key)
        {
            PostMessage(whandle, 0x0102, (IntPtr)key, IntPtr.Zero);
        }

        public static void Send(IntPtr whandle, eWindowsVirtualKey key)
        {
            SendMessage(whandle, 0x0100, (IntPtr)key, IntPtr.Zero);
        }

        public static void Send2(IntPtr whandle, eWindowsVirtualKey key)
        {
            SendMessage(whandle, 0x0102, (IntPtr)key, IntPtr.Zero);
        }
    }
}
